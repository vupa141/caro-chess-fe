...
import { getUserProfile, guestLogin, guestSignUp, login, register as signup, verifyAccount } from '@/services/user.service'
...
export const useAuthStore = defineStore('auth', () => {
    ...
    return { user, setUserStatus, register, logIn, logOut, getUser, verifyUser, guestRegister, guestLogIn }
})
